...
const Add = () => {
  ...
  return (
    <div className="flex flex-col lg:flex-row gap-8 h-full">
      {/* Categories Sidebar */}
      <div className="w-full lg:w-1/3 p-6 bg-white rounded-xl shadow-md h-full">
        <h2 className="text-xl font-semibold text-indigo-600 mb-4 text-center">WooCommerce Categories</h2>
